...
class MOrder extends CI_Model {
    ...
    public function insertOrder($numero, $nombre, $direccion, $comentarios, $sucursal, $total, $referencia) {
        try {
            $insert_id = 0;
            $data = array(
                "NumberClient" => $numero,
...
public function insertOrderDetailSauces($IdSauce, $IdSpicy, $IdDetail) {
        try {
            $data = array(
                "IdDetail" => $IdDetail,
                "IdSauce" => $IdSauce,
